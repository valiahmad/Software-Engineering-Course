...
class Model(QAbstractListModel):
    def __init__(self, data=None):
        ...
        if data is None:
            data = [
                ("افزودن عضو جدید", "res/img/icons/group.png"),
                ("تمدید عضویت", "res/img/icons/megaphone.png"),
                ("جست و جوی کتاب", "res/img/icons/contacts.png"),
                ("ثبت امانت", "res/img/icons/calls.png"),
                ("تمدید امانت", "res/img/icons/settings.png"),
                ("دریافت کتاب", "res/img/icons/moon.png"),
                ("افزودن کتاب جدید", "res/img/icons/moon.png"),
                ("گزارش", "res/img/icons/moon.png")
            ]
        self._data = data
...
class SideMenuWidget(QWidget):
    def __init__(self):
        ...
        self.app_ver.setText("version 1.0")
        ...
        self.app_about.setText("valiahmad")
